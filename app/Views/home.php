                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    ...
                                    <h2><a href="<?= base_url() ?>/details">Welcome To The Best Model Winner<br> Contest At Look of the year</a></h2>
                                </div>
                            </div>
                        </div>
                        <!-- Trending Bottom -->
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="<?php base_url() ?>/details">Get the Illusion of Fuller Lashes by “Mascng.”</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="<?php base_url() ?>/details"> Welcome To The Best Model Winner Contest</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
