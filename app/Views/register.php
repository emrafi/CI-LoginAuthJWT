    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
            <div class="position-relative d-none d-lg-block h-100 width-left">
                <img class="position-absolute img-fluid centered" src="assets/img/register.png" alt="register_picture" />
            </div>
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    <div class="align-items-center justify-content-center d-lg-none d-flex">
                        <img class="img-fluid" src="assets/img/register.png" alt="register_picture" />
                    </div>
                    <?php
                    if (session()->getFlashdata('item')) {
                        $message = session()->getFlashdata('item') ?>
                        <div class="alert alert-<?php echo $message['class'] ?>" role="alert" id="alert-register">
                            <?php echo $message['message'] ?>
                        </div>
                    <?php
                    }
                    ?>
                    <h3 class="title-text">Register to get account</h3>
                    <form style="margin-top: 1rem" action="<?php echo base_url() ?>\register" method="post">
                        <div style="margin-bottom: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.075,10.812c1.358-0.853,2.242-2.507,2.242-4.037c0-2.181-1.795-4.618-4.198-4.618S5.921,4.594,5.921,6.775c0,1.53,0.884,3.185,2.242,4.037c-3.222,0.865-5.6,3.807-5.6,7.298c0,0.23,0.189,0.42,0.42,0.42h14.273c0.23,0,0.42-0.189,0.42-0.42C17.676,14.619,15.297,11.677,12.075,10.812 M6.761,6.775c0-2.162,1.773-3.778,3.358-3.778s3.359,1.616,3.359,3.778c0,2.162-1.774,3.778-3.359,3.778S6.761,8.937,6.761,6.775 M3.415,17.69c0.218-3.51,3.142-6.297,6.704-6.297c3.562,0,6.486,2.787,6.705,6.297H3.415z" fill="#CACBCE" />
                                </svg>
                                <input class="input-field border-0" type="name" name="nama" id="" placeholder="Your Name or Alias" autocomplete="on" required />
                            </div>
                        </div>
                        <div style="margin-bottom: 1rem">
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password" id="password-content-3-5" placeholder="Your Password" minlength="8" required />
                    ...
                    <p class="text-center bottom-caption">
                        ...
                        <a href="<?php echo base_url() ?>/loginForm" style="text-decoration: none;"><span class="green-bottom-caption">Log In Here</span></a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#alert-register").fadeTo(4000, 500).slideUp(500, function() {
