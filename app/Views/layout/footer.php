        ...
        <div class="list-footer">
            <div class="row gap-md-0 gap-3">
                    ...
                    <div class="">
                        <div class="list-space">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 15.75C3.5 8.98451 8.98451 3.5 15.75 3.5H29.75C30.7165 3.5 31.5 4.2835 31.5 5.25C31.5 6.2165 30.7165 7 29.75 7H15.75C10.9175 7 7 10.9175 7 15.75V29.75C7 30.7165 6.2165 31.5 5.25 31.5C4.2835 31.5 3.5 30.7165 3.5 29.75V15.75Z" fill="#C7C7C7" />
                                <path d="M10.5 17.5C10.5 13.634 13.634 10.5 17.5 10.5H31.5C35.366 10.5 38.5 13.634 38.5 17.5V31.5C38.5 35.366 35.366 38.5 31.5 38.5H17.5C13.634 38.5 10.5 35.366 10.5 31.5V17.5Z" fill="#C7C7C7" />
                            </svg>
                        </div>
                        <nav class="list-unstyled">
                            ...
                            <li class="list-space">
                                <a href="" class="list-menu">Trending</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">Latest News</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">Category</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">About</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">Teams</a>
                            </li>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="" class="list-menu">News Mobile App</a>
                        </li>
                        <li class="list-space">
                            <a href="" class="list-menu">Magazine Mobile App</a>
                        </li>
                        <li class="list-space">
        ...
        <div class="border-color info-footer">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                ...
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <a style="margin: 0">Copyright © 2022</a>
                </nav>
            </div>
        </div>
    </div>
