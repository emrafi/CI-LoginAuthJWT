    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
            <div class="position-relative d-none d-lg-block h-100 width-left">
                <img class="position-absolute img-fluid centered" src="assets/img/login.png" alt="login_picture" />
            </div>
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    <div class="align-items-center justify-content-center d-lg-none d-flex">
                        <img class="img-fluid" src="assets/img/login.png" alt="login_picture" />
                    </div>
                    <?php
                    if (session()->getFlashdata('item')) {
                        $message = session()->getFlashdata('item') ?>
                        <div class="alert alert-<?php echo $message['class'] ?>" role="alert" id="alert-login">
                    ...
                    <form style="margin-top: 1.5rem" action="<?php base_url() ?>\login" method="post">
                        ...
                        <div class="d-flex justify-content-end" style="margin-top: 0.75rem">
                            <a href="<?php echo base_url() ?>/forgotPass" class="forgot-password fst-italic">Forgot Password?</a>
                        </div>
                    ...
                    <p class="text-center bottom-caption">
                        ...
                        <a href="<?php echo base_url() ?>/registerForm" style="text-decoration: none;"><span class="green-bottom-caption">Register Here</span></a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#alert-login").fadeTo(4000, 500).slideUp(500, function() {
